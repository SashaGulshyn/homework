...
//int intFromUser = console.nextInt();
//int int1 = intFromUser % 10;
//int int2 = intFromUser / 10 % 10;
//int int3 = intFromUser / 100;

//        int result = 1;
//        for (int i = 1; i <= intFromUser; i++) {
//            result = intFromUser * intFromUser;
//            System.out.print(intFromUser + "*");
//        }
//        System.out.println("=" + result);


    /*
    Этот метод проверит, были ли введены юзером числовые значения
     */
